 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'SanyaCross123!');
/**
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/sanyacastor/TRC2019.git');
/**
 ...
 */
define('TARGET_DIR', '/var/www/tracklocross.ru/');
/**
 ...
 * @var string Full path including the trailing slash
 */
define('TMP_DIR', '/var/www/tmp/'.md5(REMOTE_REPOSITORY).'/');
/**
